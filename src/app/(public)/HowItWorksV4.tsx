...
const STEP_VISUALS = [
  <div key="s0" className="bg-white rounded-xl border border-[var(--color-border-light)] overflow-hidden shadow-sm">
  ...
  <div key="s2" className="bg-[#0a1628] rounded-xl overflow-hidden border border-white/[0.08]">
  ...
  <div key="s3" className="bg-white rounded-xl border border-[var(--color-border-light)] overflow-hidden shadow-sm">
      ...
      <div className="container-app">
        ...
        <div className="max-w-5xl mx-auto lg:grid lg:grid-cols-2 lg:gap-16 items-start">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-all text-white ${
                        isActive ? "" : "bg-[var(--color-surface-tertiary)] text-[var(--color-text-tertiary)]"
                      }`}
                      style={{
                    ...
                    <div className="min-w-0">
                      ...
                      {isActive && (
                        <p className="text-sm text-[var(--color-text-tertiary)] mt-1.5 leading-relaxed">
                          {step.desc}
                        </p>
                      )}
                    </div>
                    <ArrowRight size={16} className={`shrink-0 mt-2 transition-all ${isActive ? "text-[var(--color-primary)] opacity-100" : "text-[var(--color-text-tertiary)]"}`} />
                  </div>
                </button>
              );
            })}
          ...
          <div className="relative">
            ...
            <div className="relative animate-fade-in" key={activeStep}>
